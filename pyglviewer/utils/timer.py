...
class Timer:
    ...
    def oscillate_translation(self, limits=[-1, 1], speed=1, offset=0, reverse=False):
        ...
        return amplitude * np.sin(speed * self.oscillate_angle(offset=offset, reverse=reverse)) + offset